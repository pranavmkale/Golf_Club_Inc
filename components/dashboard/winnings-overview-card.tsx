    ...
    <Card className="flex h-full flex-col border-border/50 bg-card/50 backdrop-blur-sm">
      ...
      <CardContent className="flex-1 pt-4">
        <div className="mb-6 flex items-baseline gap-2">
          <span className="luma-gradient-text text-4xl font-black">
        ...
        {winners.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center space-y-2 rounded-xl border-2 border-dashed border-border/50 py-8 text-center">

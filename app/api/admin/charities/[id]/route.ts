...
export async function PATCH(
  ...
  const { name, description, logo_url, cover_image_url, website_url, is_featured, is_active } = body
  ...
  if (website_url !== undefined && website_url !== '') updateData.website_url = website_url
